...
- [web_setup.yml](Ansible_YAML/web_setup.yml)
- [install_ELK.yml](Ansible_YAML/install_ELK.yml)
- [filebeat_playbook.yml](Ansible_YAML/filebeat_playbook.yml)
- [metricbeat_playbook.yml](Ansible_YAML/metricbeat_playbook.yml)
